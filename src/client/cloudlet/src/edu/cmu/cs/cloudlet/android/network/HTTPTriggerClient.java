...
public class HTTPTriggerClient extends Thread{
	...
	public HTTPTriggerClient(CloudletActivity activity, Context context, String command, String application) {
	...
	public void initSetup(String url) {
		httpURL = "http://" + CloudletActivity.SYNTHESIS_SERVER_IP + ":" + CloudletActivity.ISR_TRIGGER_PORT + "/" + url;
